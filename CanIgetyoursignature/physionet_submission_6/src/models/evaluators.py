...
if __name__ == '__main__':
    ...
    thresh, score = ThresholdOptimizer(jupyter=True, budget=200).optimize(labels, probas)
    print(score)
    ...
    thresh_new, score_new = ThresholdOptimizer(budget=200).optimize(labels, probas_new)
    print(score_new)
